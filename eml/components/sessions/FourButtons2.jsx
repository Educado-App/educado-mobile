...
export default function FourButtons2() {
  ...
  return (
    <View style={styles.container}>
      <View >
          <View style={[styles.container2,styles.buttonShadow,styles.paddingButtons, {shadowColor: selected.btn1 ? '#991f00' : '#ff3300'}]}>
          ...
          <View style={[styles.buttonShadow,styles.paddingButtons, {shadowColor: selected.btn2 ? '#003d99' : '#0066ff'}]}>
        ...
        <View>
          <View style={[styles.container2,styles.buttonShadow,styles.paddingButtons, {shadowColor: selected.btn3 ?  '#997a00' : '#ffcc00' }]}>
          ...
          <View style={[styles.buttonShadow,styles.paddingButtons, {shadowColor: selected.btn4 ?   '#267326' : '#009900'}]}>
        ...
        <View style={[styles.nextArrow, styles.buttonShadow, {shadowColor: '#2db300'}]}>
          <Icon
                size={70}
                name='check-bold'
                type='material-community'
