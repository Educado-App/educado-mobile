			...
			<AlertNotificationRoot>
				...
				<View className="mb-6">
					...
					<View className="flex-row justify-start mt-1 h-6">
						<Text testId="passwordLengthAlert" className={'text-sm' + ((passwordLengthValid || !password) ? 'text-sm text-gray-500' : 'text-sm text-error')}>
              ...
              • Mínimo 8 caracteres
					...
					<View className="flex-row justify-start h-6">
						<Text testId="passwordLetterAlert" className={'text-sm' + ((passwordContainsLetter || !password) ? 'text-sm text-gray-500' : 'text-sm text-error')}>
