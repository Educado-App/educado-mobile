...
const validateName = (name, wordForName='Nome') => {
  ...
  if (name.length > 50) { // Check this number
    return `${wordForName} muito longo`; // TODO: Translate "Name too long"
  }
  if(name.length < 1) {
    return `${wordForName} obrigatório`; // TODO: Translate "Name required"
  }
...
// TODO: Rename RemoveEmojis to use camelCase
